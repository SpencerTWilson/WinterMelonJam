...
var text: Array[String] = [
	...
	"[center]They have been polarized against eachother.\nwhich is good for business![/center]",
	"[center]The red base acted first. buy sending out a troop.[/center]",
	"[center]Both bases will send these troops at eachother.[/center]",
